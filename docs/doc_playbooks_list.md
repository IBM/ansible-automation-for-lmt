...
<table>
  ...
  <tr>    
    <td colspan="4">
        ...
        If the <code>{{lmt_server_token}}</code> parameter is defined, the computer is automatically decommissioned from the License Metric Tool server after the scanner is unintstalled from that computer.<br/><br/>  
